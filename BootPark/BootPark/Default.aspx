        ...
        <ext:Panel runat="server" Width="650" Height="300">
            <Items>
                        ...
                        <ext:GridPanel 
                            ...
                            <ColumnModel>
                                <Columns>
                                    <ext:Column runat="server" ColumnID="Name"  Text="Record Name" Width="160" DataIndex="Name" />
                                    <ext:Column runat="server" Header="Column 1" Width="60" DataIndex="Column1" />
                                    <ext:Column runat="server" Header="Column 2" Width="60" DataIndex="Column2" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
                        ...
                        <ext:GridPanel 
                            ...
                            <ColumnModel>
                                <Columns>
                                    <ext:Column runat="server" ColumnID="Name" Header="Record Name" Width="160" DataIndex="Name" />
                                    <ext:Column runat="server" Header="Column 1" Width="60" DataIndex="Column1" />
                                    <ext:Column runat="server" Header="Column 2" Width="60" DataIndex="Column2" />
                                </Columns>
                            </ColumnModel>
